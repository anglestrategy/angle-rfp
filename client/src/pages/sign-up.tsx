      ...
      <div className="hidden lg:flex lg:w-[55%] relative bg-foreground overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.04]">
          <svg width="100%" height="100%">
            ...
            <rect width="100%" height="100%" filter="url(#auth-grain-up)" />
          </svg>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-8">
              Start analyzing RFPs in minutes. No credit card required.
            </p>
            ...
            <form
              onSubmit={async (e) => {
                ...
                setSubmitting(true);
                try {
                  await apiRequest("POST", "/api/auth/sign-up", {
                    fullName: name,
                    email,
                    password,
                  });
